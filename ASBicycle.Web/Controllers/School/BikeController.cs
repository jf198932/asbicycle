...
{
    public class BikeController : ASBicycleControllerBase
    {
        private readonly IBikeRepository _bikeRepository;
        private readonly IUserRepository _userRepository;
        private readonly IBikesiteRepository _bikesiteRepository;

        public BikeController(IBikeRepository bikeRepository, IUserRepository userRepository, IBikesiteRepository bikesiteRepository)
        {
        ...
        {
            Mapper.CreateMap<Entities.Bike, BikeModel>();
