...
namespace ASBicycle
{
    ...
    {
        private readonly IDbContextProvider<ASBicycleDbContext> _dbContextProvider;
        public SqlExecuter(IDbContextProvider<ASBicycleDbContext> dbContextProvider) { _dbContextProvider = dbContextProvider; }
