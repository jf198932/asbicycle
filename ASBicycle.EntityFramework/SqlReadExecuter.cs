...
namespace ASBicycle
{
    ...
    {
        private readonly IDbContextProvider<ReadonlyASBicycleDbContext> _dbContextProvider;
        public SqlReadExecuter(IDbContextProvider<ReadonlyASBicycleDbContext> dbContextProvider) { _dbContextProvider = dbContextProvider; }
